<div class="bl_footer">
    ...
    get_theme_file_uri("/img/logo_footer.svg")
        ...
        <div class="bl_snsLinks">
            ...
            <a href="" class="bl_snsLinks_link"><i class="fa-brands fa-twitter"></i></a>
            <a href="" class="bl_snsLinks_link"><i class="fa-brands fa-instagram"></i></a>
        </div>

        <p class="el_copyRight">@copy;2022 LUSSO Automobile</p>
    ...
    <div class="bl_footer_right">
        <nav class="bl_footerNav">
            <ul class="bl_footerNav_list">
                ...
                <li><a class=" bl_footerNav_link" href="#">CONTACT</a></li>
                <li><a class=" bl_footerNav_link" href="#">プライバシーポリシー</a></li>
